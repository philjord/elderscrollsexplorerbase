...
public class GameConfig {
	 ...
	 * 
	 * if (version == 0.94f) { if (esmManager.getName().equals("Skyrim.esm")) { j3dCellFactory = new
	 * esmj3dtes5.j3d.cell.J3dCellFactory(esmManager, esmManager, mediaSources); } else {
	 * 
	 * j3dCellFactory = new esmj3dfo3.j3d.cell.J3dCellFactory(esmManager, esmManager, mediaSources); } } else if
	 * (version == 1.32f) { j3dCellFactory = new esmj3dfo3.j3d.cell.J3dCellFactory(esmManager, esmManager,
	 * mediaSources); } else if (version == 1.0f || version == 0.8f) { j3dCellFactory = new
	 * esmj3dtes4.j3d.cell.J3dCellFactory(esmManager, esmManager, mediaSources); } else if (version == 1.2f) {
	 * j3dCellFactory = new esmj3dtes3.j3d.cell.J3dCellFactory(esmManager, esmManager, mediaSources); } else {
